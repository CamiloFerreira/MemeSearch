...
?>	
            ...
            <aside id="aside_1">
                <h2>TOP 5 Del Dia</h2>
<?php
$query = "SELECT meme,sum(cantidad_v) FROM imagenes INNER JOIN puntuaciones on puntuaciones.id_imagen=imagenes.id_imagen where puntuaciones.fecha='$fecha' GROUP by meme order by suma_v desc limit 5";
